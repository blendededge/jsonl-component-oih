...
const ATTACHMENT_STORAGE_SERVICE_BASE_URL = process.env.ELASTICIO_ATTACHMENT_STORAGE_SERVICE_BASE_URL || 'http://attachment-storage-service.oih-prod-ns.svc.cluster.local';
...
class AttachmentProcessor {
  ...
  static async preparePutUrl() {
    ...
    console.log(`Attachment Storage Service signed url is ${signedUrl}`);
    return signedUrl;
  }
  ...
  static createSignedUrl() {
    return `${ATTACHMENT_STORAGE_SERVICE_BASE_URL}/objects/${uuid.v4()}`;
  }
}
